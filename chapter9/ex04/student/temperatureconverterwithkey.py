# temperatureconverterwithkey.py
# Temperature Converter with Return-key functionality
...
# ----- Bind the Return key -----
cel_entry.bind("<Return>", celsius_to_fahrenheit)      # Enter converts C → F
fah_entry.bind("<Return>", fahrenheit_to_celsius)      # Enter converts F → C
